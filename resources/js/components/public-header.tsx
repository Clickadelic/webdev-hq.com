...
export default function PublicHeader({
    ...
    return (
        <>
            <div className="w-full border-emerald-400 bg-emerald-300 py-2">
                <div className="container mx-auto text-center">
                    <p className="font-medium text-emerald-800">
                        This project is currently in early beta. Please come
                            ...
                            {auth.user ? (
                                ...
                                <ul className="my-2.5 flex justify-end gap-3">
                                    ...
                                    <li>
                                        <Link
                                            href={login.url()}
                                            className="hover:bg-primary-hover flex items-center justify-between gap-2 rounded-sm border border-slate-500 bg-primary px-3 py-2 text-white hover:bg-primary/90"
                                        >
