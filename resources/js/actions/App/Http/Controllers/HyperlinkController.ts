 ...
 * @see app/Http/Controllers/HyperlinkController.php:17
 * @route '/hyperlinks'
 */
 ...
 * @see app/Http/Controllers/HyperlinkController.php:29
 ...
 * @see app/Http/Controllers/HyperlinkController.php:37
 * @route '/hyperlinks'
 */
 ...
 * @see app/Http/Controllers/HyperlinkController.php:49
...
show.url = (args: { hyperlink: number | { id: number } } | [hyperlink: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
                        hyperlink: typeof args.hyperlink === 'object'
                ? args.hyperlink.id
                : args.hyperlink,
                }
 ...
 * @see app/Http/Controllers/HyperlinkController.php:59
 ...
 * @see app/Http/Controllers/HyperlinkController.php:69
 * @route '/hyperlinks/{hyperlink}'
 */
 ...
 * @see app/Http/Controllers/HyperlinkController.php:81
 * @route '/hyperlinks/{hyperlink}'
 */
...
const HyperlinkController = { index, create, store, show, edit, update, destroy }
