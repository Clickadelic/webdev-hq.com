...
### 18. React & Inertia.js → `rules/react-inertia.md`

- `Inertia::render()` to pass data from controllers to React pages
- Shared data via `HandleInertiaRequests` middleware
- ShadCN/UI components with Radix UI primitives
- Type-safe routing with Wayfinder
- `react-hook-form` + Zod for client-side form handling
...
- No HTML in PHP classes; keep PHP logic out of React components
