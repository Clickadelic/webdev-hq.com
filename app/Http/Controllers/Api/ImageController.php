...
use App\Http\Requests\FetchUnsplashImageRequest;
...
{
	public function index(FetchUnsplashImageRequest $request, UnsplashImageService $unsplashImageService): JsonResponse
	{
